...
<body>
    ...
    <div class="container-fluid text-center p-0 m-0">
        <div class="position-relative">
            <img src="assets/img/principal.jpg" class="img-fluid w-100" alt="Título">
    ...
    <section class="container my-5">
        <div class="card shadow p-4 mx-auto" style="max-width: 600px; border-radius: 15px;">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Olá, <strong><?php echo $_SESSION['nome']; ?></strong></p>
            </div>
            ...
            <form method="POST" action="agendar.php">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="servico" required>
                        ...
                        <option>Corte + Sobrancelha + Barba</option>
                        <option>Sobrancelha</option>
                        <option>Lavagem e Hidratação</option>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="observacao" rows="3"
                        placeholder="Alguma preferência ou pedido especial?"></textarea>
                </div>
    ...
    <div class="container d-none d-md-block mb-4">
        <div class="row">
            <div class="col-md-4 mb-3">
                <img src="assets/img/foto 1.png" style="height: 200px; width: 100%; object-fit: cover;"
                    class="img-fluid rounded foto-hover" alt="foto 1">
            </div>
            <div class="col-md-4 mb-3">
                <img src="assets/img/foto 1.2.png" style="height: 200px; width: 100%; object-fit: cover;"
                    class="img-fluid rounded foto-hover" alt="foto 2">
            </div>
            <div class="col-md-4 mb-3">
                <img style="height: 200px; width: 100%; object-fit: cover;" src="assets/img/foto 2.png"
                    class="img-fluid rounded foto-hover" alt="foto 3">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 mb-3">
                <img src="assets/img/foto 2.1.png" style="height: 200px; width: 100%; object-fit: cover;"
                    class="img-fluid rounded foto-hover" alt="foto 4">
            </div>
            <div class="col-md-4 mb-3">
                <img src="assets/img/foto 3.png" style="height: 200px; width: 100%; object-fit: cover;"
                    class="img-fluid rounded foto-hover" alt="foto 5">
            </div>
            <div class="col-md-4 mb-3">
                <img src="assets/img/foto 3.1.png" style="height: 200px; width: 100%; object-fit: cover;"
                    class="img-fluid rounded foto-hover" alt="foto 6">
            </div>
        </div>
    </div>
    ...
    <div id="carouselFotos" class="carousel slide d-block d-md-none text-center mx-auto mb-4" data-bs-ride="carousel"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/foto 1.png" class="d-block w-100 rounded" alt="Foto 1">
            </div>
            <div class="carousel-item">
                <img src="assets/img/foto 1.2.png" class="d-block w-100 rounded foto-hover" alt="foto 2">
            </div>
            <div class="carousel-item">
                <img src="assets/img/foto 2.png" class="d-block w-100 rounded" alt="foto 3">
            </div>
            <div class="carousel-item">
                <img src="assets/img/foto 2.1.png" class="d-block w-100 rounded" alt="foto 4">
            </div>
            <div class="carousel-item">
                <img src="assets/img/foto 3.png" class="d-block w-100 rounded" alt="foto 5">
            </div>
            <div class="carousel-item">
                <img src="assets/img/foto 3.1.png" class="d-block w-100 rounded" alt="foto 6">
            </div>
        </div>
