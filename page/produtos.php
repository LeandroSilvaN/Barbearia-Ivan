...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="menu">
        <ul class="navbar-nav">
          ...
          <div class="d-flex justify-content-center justify-content-lg-end mt-3 mt-lg-0 ms-lg-3" id="navbarNav">
  ...
  <section>
    ...
    <div class="produtos">
      <!-- Primeira linha -->
      <div class="produto">
        <img src="../assets/img/Shampoo.png.webp" alt="Shampoo Ice">
        <h4>Shampoo Ice para Barba e Cabelo - 220ml - Premium - Barba de Respeito</h4>
        <p>R$ 59,90</p>
      </div>
      <div class="produto">
        <img src="../assets/img/Shampoo1litro.png.webp" alt="Shampoo 1 litro">
        <h4>Shampoo Para Barba e Cabelo Refrescante - 1L - Barba de Respeito</h4>
        <p>R$ 159,90</p>
      </div>
      <div class="produto">
        <img src="../assets/img/shampoebarba.webp" alt="Shampoo Essencial">
        <h4>Shampoo de Barba 200ml - Linha Essencial - Barba de Respeito</h4>
        <p>R$ 34,90</p>
      </div>

      <!-- Segunda linha -->
      <div class="produto">
        <img src="../assets/img/Pomodelador.png.webp" alt="Pó Modelador">
        <h4>Pó Modelador Fixação Extrema - Premium - Barba de Respeito</h4>
        <p>R$ 79,90</p>
      </div>
      <div class="produto">
        <img src="../assets/img/Anticalvice.png.webp" alt="Blend Capilar">
        <h4>Blend Capilar - Tônico pró Crescimento + Shampoo Antiqueda - Barba de Respeito</h4>
        <p>R$ 99,90</p>
      </div>
      <div class="produto">
        <img src="../assets/img/Cera.png.webp" alt="Cera Modeladora">
        <h4>Cera Modeladora Cabelos Efeito Molhado - 80g - Premium - Barba de Respeito</h4>
        <p>R$ 69,90</p>
      </div>

      <!-- Terceira linha -->
      <div class="produto">
        <img src="../assets/img/Escurecedor.png.webp" alt="Escurecedor">
        <h4>Escurecedor Barba e Cabelo - Premium - Barba de Respeito</h4>
        <p>R$ 89,90</p>
      </div>
      <div class="produto">
        <img src="../assets/img/blend_e_shampoo_ice.webp" alt="Blend Original">
        <h4>Blend Original® para Crescimento de Barba - 1 Mês de Tratamento - Barba de Respeito</h4>
        <p>R$ 78,90</p>
      </div>
      <div class="produto">
        <img src="../assets/img/blend_barba.webp" alt="Blend Combo">
        <h4>Blend Original 30 ml + Shampoo Refrescante Para Barba Ice 220 ml</h4>
        <p>R$ 109,90</p>
      </div>
    </div>
  </section>
